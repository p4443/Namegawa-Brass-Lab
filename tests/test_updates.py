...
class UpdatesTest(unittest.TestCase):
    ...
    def test_contract_generator_requires_editor_login_in_page(self):
        ...
        self.assertIn("values.route_document_url = mapsUrl", page)
        self.assertIn("if (routeDocumentInput) routeDocumentInput.value = mapsUrl", page)
        self.assertIn("if (routeMapLink) routeMapLink.href = mapsUrl", page)
        self.assertIn("freightCalculatorStatus.dataset.mapsUrl = mapsUrl", page)
