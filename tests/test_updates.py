...
class UpdatesTest(unittest.TestCase):
    ...
    def test_contract_generator_requires_editor_login_in_page(self):
        ...
        self.assertEqual(page.count('class="document-page master-page"'), 3)
        self.assertIn(".master-page:last-child { break-after: auto; }", page)
        self.assertIn('.document[data-contract-type^="type"] { font-size: 10pt; line-height: 1.65; }', page)
        ...
        self.assertIn("partyHtml(type === 'master')", page)
